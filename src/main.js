...
const getCorneKeys = () => {
    const keysLayout = [
        ...
        { row: 2, col: 13},
        { row: 2, col: 14},
        { row: 3.2, col: 4, w: 1, cls: "action"},
        { row: 3.2, col: 5, w: 1, cls: "action"},
        { row: 3.2, col: 6, w: 1, cls: "action"},
        { row: 3.2, col: 8, w: 1, cls: "action"},
        { row: 3.2, col: 9, w: 1, cls: "action"},
        { row: 3.2, col: 10, w: 1, cls: "action"},
    ];
...
const getDactylKeys = () => {
    const keysLayout = [
        ...
        { row: 2, col: 10},
        { row: 2, col: 11},
        { row: 3.2, col: 1.5, w: 1.8, cls: "action"},
        { row: 3.2, col: 3.2, w: 1.8, cls: "action"},
        { row: 3.2, col: 7, w: 1.6, cls: "action"},
        { row: 3.2, col: 8.8, w: 1.8, cls: "action"},
    ];
